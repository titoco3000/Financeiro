...
public class Input_Data : MonoBehaviour
{
    ...
    {
        Data d = new Data(System.DateTime.Now.AddDays(defaultDay).AddMonths(defaultMonth).AddYears(defaultYear));
        field.text = d.ReducedString();
